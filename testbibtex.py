...
class TestAuthorExtract(unittest.TestCase):
    ...
    # Note that the rules for extracting bibtex author names  is  actually quite  complicated.
    # As  these  test  cases  illustrate .  I  haven ’t implemented  all  the  cases .  ”””
